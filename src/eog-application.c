...
eog_application_init_accelerators (GtkApplication *application)
{
	...
	static const gchar * const accelmap[] = {
		...
		"win.go-next",		"Space", NULL,
		"win.go-first",		"<Alt>Home", "Home", NULL,
		"win.go-last",		"<Alt>End", "End", NULL,
		"win.go-random",	"<Ctrl>m", NULL,

		"win.rotate-90",	"r", NULL,
		"win.rotate-270",	"<Alf>r", NULL,

		"win.move-trash",	"<Alt>Delete", NULL,
		"win.delete",		"<Ctrl>Delete", NULL,
		"win.copy",		"<Ctrl>c", NULL,
		"win.undo",		"<Ctrl>z", NULL,

		"win.zoom-in",		"<Ctrl>equal", "<Ctrl>KP_Add", "<Ctrl>plus", NULL,
		"win.zoom-out",		"<Ctrl>minus", "<Ctrl>KP_Subtract", NULL,
		"win.zoom-normal",	"2", "x", NULL,

		"win.view-gallery",	"F1", NULL,
		"win.view-sidebar",	"F3", NULL,
		"win.view-fullscreen",	"f", NULL,
		"win.view-slideshow",	"s", NULL,
		"win.toggle-zoom-fit",	"1", "a", NULL,
		"win.toggle-gear-menu",	"F9", NULL,
		"win.pause-slideshow",	"z", NULL,
